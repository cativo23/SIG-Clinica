...
from .views import obtener_resumen_expcreados, obtener_resumen_costomed, obtener_resumen_expdeudas, \
    obtener_resumen_ingresoConsultas, index, menu, obtener_resumen_tratmientosreq
...
urlpatterns = [
    ...
    path('resumen_tratamientosreq/', obtener_resumen_tratmientosreq, name='resumen_tratamientoreq'),
]
